function Find-RyverMessage {
    ...
    .LINK
        https://tlindsay42.github.io/PSRyver/Public/Find-RyverMessage/

    .LINK
        https://github.com/tlindsay42/PSRyver/blob/master/PSRyver/Public/Find-RyverMessage.ps1

    .FUNCTIONALITY
        Ryver
    #>
    [CmdletBinding(
        HelpUri = 'https://tlindsay42.github.io/PSRyver/Public/Find-RyverMessage/',
        SupportsPaging = $true
    )]
