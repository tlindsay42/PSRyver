function Find-RyverAttachment {
    ...
    .LINK
        https://tlindsay42.github.io/PSRyver/Public/Find-RyverAttachment/

    .LINK
        https://github.com/tlindsay42/PSRyver/blob/master/PSRyver/Public/Find-RyverAttachment.ps1

    .FUNCTIONALITY
        Ryver
    #>
    [CmdletBinding(
        HelpUri = 'https://tlindsay42.github.io/PSRyver/Public/Find-RyverAttachment/',
        SupportsPaging = $true
    )]
