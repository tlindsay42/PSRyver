function Find-RyverTopicComment {
    <#
    .SYNOPSIS
    ...
    .LINK
        https://tlindsay42.github.io/PSRyver/Public/Find-RyverTopicComment/

    .LINK
        https://github.com/tlindsay42/PSRyver/blob/master/PSRyver/Public/Find-RyverTopicComment.ps1

    .FUNCTIONALITY
        Ryver
    #>
    [CmdletBinding(
        HelpUri = 'https://tlindsay42.github.io/PSRyver/Public/Find-RyverTopicComment/',
        SupportsPaging = $true
    )]
