function Find-RyverTask {
    ...
    .LINK
        https://tlindsay42.github.io/PSRyver/Public/Find-RyverTask/

    .LINK
        https://github.com/tlindsay42/PSRyver/blob/master/PSRyver/Public/Find-RyverTask.ps1

    .FUNCTIONALITY
        Ryver
    #>
    [CmdletBinding(
        HelpUri = 'https://tlindsay42.github.io/PSRyver/Public/Find-RyverTask/',
        SupportsPaging = $true
    )]
