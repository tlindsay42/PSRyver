...
$public = Join-Path -Path $moduleRoot -ChildPath 'Public' |
...
# Create / Read config
$Script:PSRyverConfigFilePath = Get-PSRyverConfigPath
if ( ( Test-Path -Path $Script:PSRyverConfigFilePath ) -eq $true ) {
    Import-PSRyverConfig -ErrorAction 'Stop'
}
else {
    Initialize-PSRyverConfig -ErrorAction 'Stop'
}
...
<#
Create a hashtable for use with the "leaky bucket" rate-limiting algorithm.
(Some of Ryver's API calls will fail if you request them too quickly.)
https://en.wikipedia.org/wiki/Leaky_bucket
#>
$Script:ApiRateBuckets = @{}

# Import some color definitions.
