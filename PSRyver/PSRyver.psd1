...
FunctionsToExport = 'Export-PSRyverConfig', 'Find-RyverMessage', 'Find-RyverTopic',
               'Get-PSRyverConfig', 'Get-PSRyverConfigPath', 'Get-RyverForum',
               'Get-RyverHistory', 'Get-RyverTeam', 'Get-RyverUser',
...
FileList = 'PSRyver.psd1', 'PSRyver.psm1', 'Private\Assert-RyverApiConfig.ps1',
               ...
               'Public\Find-RyverTopic.ps1', 'Public\Get-PSRyverConfig.ps1',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Add Find-RyverTopic'
