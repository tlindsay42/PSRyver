...
FunctionsToExport = 'Export-PSRyverConfig', 'Find-RyverMessage', 'Get-PSRyverConfig',
               'Get-PSRyverConfigPath', 'Get-RyverForum', 'Get-RyverHistory',
               'Get-RyverTeam', 'Get-RyverUser', 'Import-PSRyverConfig',
               'Initialize-PSRyverConfig', 'Invoke-RyverRestMethod',
               'Read-PSRyverConfig', 'Remove-PSRyverConfig', 'Remove-RyverMessage',
               'Send-RyverMessage', 'Set-PSRyverConfig', 'Set-PSRyverConfigPath'
...
FileList = 'PSRyver.psd1', 'PSRyver.psm1', 'Private\Assert-RyverApiConfig.ps1',
               ...
               'Public\Export-PSRyverConfig.ps1', 'Public\Find-RyverMessage.ps1',
               ...
               'Public\Remove-RyverMessage.ps1', 'Public\Set-PSRyverConfig.ps1',
               'Public\Send-RyverMessage.ps1', 'Public\Set-PSRyverConfigPath.ps1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Add Find-RyverMessage'
